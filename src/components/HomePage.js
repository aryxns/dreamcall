...
function HomePage() {
    ...
    return(
        ...
        <div className="content-start text-white font-mono text-left">
            <h1 className="m-10 text-2xl"><span className="p-2 bg-gray-900">Dream.Call</span><button onClick={Login} className="ml-10 md:ml-20 underline text-black">LOGIN</button></h1>
