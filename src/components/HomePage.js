...
function HomePage() {
    ...
    return(
        ...
        <div className="content-start text-white font-mono text-left">
            <div className="m-10 text-2xl"><span className="float-left p-2 bg-gray-900">Dream.Call</span><button onClick={Login} className="float-right underline text-black">LOGIN</button></div>
            <p className="mt-10 ml-10 text-xl  text-black">asking for meetings over twitter DMs sucks 😡</p>
